...
[System.Reflection.Assembly]::LoadFrom((get-item $PSScriptRoot ).parent.FullName+'\bin\MVC.RBAC.dll') | Out-null
...
$Connection.ConnectionString=[System.Configuration.ConfigurationManager]::ConnectionStrings["XCodeConnection"].ConnectionString

$MyPermissionProvider = new-object MVC.RBAC.Security.PermissionProvider
